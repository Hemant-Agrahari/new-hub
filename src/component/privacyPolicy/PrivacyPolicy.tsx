...
import CustomMuiAccordion from '../common/mui-component/CustomMuiAccordion'
import CustomMuiAccordionSummary from '../common/mui-component/CustomMuiAccordionSummary'
import CustomMuiAccordionDetails from '../common/mui-component/CustomMuiAccordionDetails'
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            <Typography className="ms-4 text-white font-weight-500">
                              {item?.question}
                            </Typography>
                          </CustomMuiAccordionSummary>
                          <CustomMuiAccordionDetails className="text-white">
                            <Typography className="accordion-answer-text">
                              {item?.answer}
                            </Typography>
