      ...
      <div className="leaderboardPrize-col">
        ...
        <div className="leader-row">
          <div className="leader-col">
            ...
            <Image src="/assets/images/leaderTop-2.png" alt='Second Place' width={55} height={55}/>
          ...
          <div className="leader-col">
            ...
            <Image src="/assets/images/leaderTop-1.png" alt='First Place' width={55} height={55} />
          ...
          <div className="leader-col">
            ...
            <Image src="/assets/images/leaderTop-3.png" alt='Third Place' width={55} height={55} />
            <div className="leader-user">User820769654</div>
            <div className="leader-price">$ 8413570</div>
          </div>
        </div>
